...
Video.create(:title => 'Travel Blender', :user_id => 1, :sold => 42, :notsold => 19, :id => 1)
Video.create(:title => 'Monkey Business', :user_id => 1, :sold => 105, :notsold => 189, :id => 2)
Video.create(:title => 'Bumble Fumble', :user_id => 1, :sold => 79, :notsold => 182, :id => 3)
Video.create(:title => 'The Best App Ever', :user_id => 2, :sold => 333, :notsold => 13, :id => 4)
Video.create(:title => 'Another Web App', :user_id => 2, :sold => 67, :notsold => 98, :id => 5)
